...
Reddit = praw.Reddit(client_id = os.getenv("REDDIT_ID"), client_secret = os.getenv("REDDIT_SECRET"), user_agent = "ZBot by u/Kamlin333")

Covid = COVID19Py.COVID19(data_source = "jhu")

Imgur = imgurpython.ImgurClient(client_id = os.getenv("IMGUR_ID"), client_secret = os.getenv("IMGUR_SECRET"))
